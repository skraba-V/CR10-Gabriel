    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        <div class='row text-center justify-content-center'>
            ...
            <div class='col-12 nsl'>
                ...
                <div class='dimgbox'>
                    <img class='ditimg' src='./pictures/".$row['photo']."'>
            ...
            <div class='col-12'>
            <a href='update.php?id=".$row['library_id']."'><button class='button' type='button'>Edit</button></a>
            <a href='delete.php?id=".$row['library_id']."'><button class='button button2' type='button'>Delete</button></a>
